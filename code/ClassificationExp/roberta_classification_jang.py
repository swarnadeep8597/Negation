...
pre_trained_model = '/Users/sbhar/Riju/PhDCode/Naacl_Neg/code/ClassificationExp/BigBert/rl_pytorch_model.bin'
...
def load_model(model_path):
        ...
        model.roberta.load_state_dict(load_plm_state_dict(model_path, 'roberta'))
        return model
...
def masked_inference_vanilla():
        ...
        text = "Paris is the capital of france.Paris is not the capital of <mask>."
...
def batch_vanilla(json_file_path):
        ...
        #tokenizer = RobertaTokenizer.from_pretrained("bert-large-uncased")
        #model = RobertaForMaskedLM.from_pretrained("bert-large-uncased")
        ...
        """
        with open('/Users/sbhar/Riju/PhDCode/Naacl_Neg/code/ClassificationExp/mismatches/roberta_vanilla_matches.json','w') as file:
...
def batch_finetuned(json_file_path):
        ...
        """
        with open('/Users/sbhar/Riju/PhDCode/Naacl_Neg/code/ClassificationExp/mismatches/roberta_finetuned_matches.json','w') as file:
                json.dump(matches,file,indent=4)
        """
...
if __name__ == "__main__":
        ...
        match, total, _, _ = batch_vanilla('/Users/sbhar/Riju/PhDCode/Naacl_Neg/code/ClassificationExp/BigBert/jang-data/dataset-roberta.jsonl')
        ...
        print("----------------------------------")
        match, total, _, _ = batch_finetuned('/Users/sbhar/Riju/PhDCode/Naacl_Neg/code/ClassificationExp/BigBert/jang-data/dataset-roberta.jsonl')
        print(f"The total samples are: {total}")
